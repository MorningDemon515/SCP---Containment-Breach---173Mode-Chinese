...
Function FillRoom(r.Rooms)
	...
	Local d.Doors, d2.Doors, sc.SecurityCams, de.Decals, r2.Rooms, sc2.SecurityCams, v.Vents, b.BreakableObjects
	Local it.Items, i%
...
;			CameraFogMode dp\cam,1
		...
		Case "lockroom"
			...
			r\RoomVents[1] = CreateVentSpot(r\x + -656.0 * RoomScale, r\y + 544.0 * RoomScale, r\z + 448.0 * RoomScale, r, 0.925*RoomScale, 0.925*RoomScale)
		...
		Case "room2testroom2"
			...
			b = CreateBreakableObject(r\x - 632.0 * RoomScale, 224.0*RoomScale, r\z - 210.0 * RoomScale, 0, 0, 0, r\x - 669.0 * RoomScale, 0.5, r\z - 16.0 * RoomScale, "glass", r)
			...
			d\AutoClose = False : d\open = True					
			r\RoomVents[1] = CreateVentSpot(r\x - 634.0 * RoomScale, r\y + 544.0 * RoomScale, r\z - 806.0 * RoomScale, r, 0.925*RoomScale, 0.925*RoomScale)
			;-634 372.956 -806
		...
		Case "room2shaft"
			;[Block]
			d = CreateDoor(r\zone, r\x + 1552.0 * RoomScale, r\y, r\z + 552.0 * RoomScale, 0, r, True, False)
...
;			
		...
		Case "room513"
			;[Block]
			d = CreateDoor(r\zone, r\x - 704.0 * RoomScale, 0, r\z + 304.0 * RoomScale, 0, r, True, 0, 2)
		...
		Case "room966"
			;[Block]
			r\RoomDoors[1] = CreateDoor(r\zone, r\x - 400.0 * RoomScale, 0, r\z, -90, r, False, False, 3)
			r\RoomDoors[2] = CreateDoor(r\zone, r\x, 0, r\z - 480.0 * RoomScale, 180, r, False, False, 3)
			;: d\buttons[0] = False
			;PositionEntity (d\buttons[0], EntityX(d\buttons[0],True), EntityY(d\buttons[0],True), r\z + 288.0 * RoomScale, True)
			;PositionEntity (d\buttons[1], EntityX(d\buttons[1],True), EntityY(d\buttons[1],True), r\z + 320.0 * RoomScale, True)
		...
		Case "room3storage"
			...
			r\RoomDoors[4]\AutoClose = False : r\RoomDoors[4]\open = True
			For i = 0 To 1
		...
		Case "tunnel2"
			...
			r\RoomVents[1] = CreateVentSpot(r\x + 0.0 * RoomScale, r\y + 544.0 * RoomScale, r\z + 0.0 * RoomScale, r, 0.925*RoomScale, 0.925*RoomScale)
			;[End Block]
		Case "room2pipes"
			;[Block]
			r\Objects[0]= CreatePivot(r\obj)
		...
		Case "room2servers"
			...
			r\RoomDoors[0] = CreateDoor(r\zone, r\x - 208.0 * RoomScale, 0.0, r\z - 736.0 * RoomScale, 90, r, False, False, False, "", True)
			r\RoomDoors[0]\locked = True;\AutoClose=False
			r\RoomDoors[1] = CreateDoor(r\zone, r\x - 208.0 * RoomScale, 0.0, r\z + 736.0 * RoomScale, 90, r, False, False, False, "", True)
			r\RoomDoors[1]\locked = True;\AutoClose=False
...
;			PositionEntity(r\Objects[6], r\x - 848*RoomScale, 0.5, r\z-576*RoomScale, True)
		...
		Case "room2closets"
			...
			r\RoomVents[1] = CreateVentSpot(r\x - 1152.0 * RoomScale, r\y + 334.0 * RoomScale, r\z + 4.0 * RoomScale, r, 0.925*RoomScale, 0.925*RoomScale)
			HideEntity r\RoomVents[1]\obj%
		...
		Case "start"
			;[Block]
			r\RoomVents[1] = CreateVentSpot(r\x + 2944.0 * RoomScale, r\y + 1160.0 * RoomScale, r\z + 554.0 * RoomScale, r, 0.925*RoomScale, 0.925*RoomScale)
			...
			r\Objects[8] = CreatePivot()
			PositionEntity (r\Objects[8], EntityX(r\obj) + 704  * RoomScale, 128.0 * RoomScale, EntityZ(r\obj) + 992.0 * RoomScale)
			
			r\Objects[9] = CreatePivot() ; Cutscene pivot
			PositionEntity (r\Objects[9], EntityX(r\obj) + 3328  * RoomScale, 823.0 * RoomScale, EntityZ(r\obj) + 1968.0 * RoomScale)
			;3328 823 1968
			
			;r\Objects[8] = CreatePivot() ;Vent
			;PositionEntity (r\Objects[8], EntityX(r\obj) + 2944.0 * RoomScale, EntityY(r\obj) + 900.0 * RoomScale, EntityZ(r\obj) + 544.0 * RoomScale) ;+ 1148.0 * RoomScale, EntityZ(r\obj) + 544.0 * RoomScale)
			;EntityParent (r\Objects[8],r\obj)
		...
		Case "room2doors"
			...
			r\RoomVents[1] = CreateVentSpot(r\x - 812.0 * RoomScale, r\y + 396.0 * RoomScale, r\z + 0.0 * RoomScale, r, 0.925*RoomScale, 0.925*RoomScale)
		...
		For y = MapHeight - 1 To 1 Step - 1
			...
			For x = 1 To MapWidth - 2
				...
				ElseIf MapTemp(x, y) > 0
					...
					Select temp ;the number of rooms in the adjacent boxes
						Case 1
			...
			Next
		Next
	ElseIf mode% = 1 Then ; if the second mode is selected
...
;~F#A#35#10D#114#11B#122#13B#143#140E
;~B#1223
;~C#Blitz3D